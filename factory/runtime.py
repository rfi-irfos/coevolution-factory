...
.cmpanel{{position:relative;width:calc(100vw - 48px);max-width:1180px;height:min(860px,92vh);max-height:92vh;margin:auto;background:#0a0e14;border:1px solid #1c2733;border-radius:20px;box-shadow:0 30px 80px rgba(0,0,0,.6);overflow:hidden;display:flex;flex-direction:column;box-sizing:border-box}}
